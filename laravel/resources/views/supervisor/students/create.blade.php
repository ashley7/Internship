...
<div class="card">
    ...
    <div class="card-body p-4">
        <form action="{{ route('supervisor.students.store') }}" method="POST">
            @csrf
            <h6 class="text-muted fw-semibold mb-3" style="font-size:.78rem;letter-spacing:.5px;text-transform:uppercase;">Account Information</h6>
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                           value="{{ old('email') }}" placeholder="student@university.ac.ug" required>
            ...
            <h6 class="text-muted fw-semibold mb-3" style="font-size:.78rem;letter-spacing:.5px;text-transform:uppercase;">Academic Information</h6>
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label">School / University *</label>
                    <input type="text" name="school" class="form-control @error('school') is-invalid @enderror"
                           value="{{ old('school') }}" placeholder="e.g. Makerere University" required>
